...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='A mouse learning to get to the cheese using reinforcement learning')
    parser.add_argument('-m', '--method', type=str, default='Mouse',
                        help='''Choose the learning algorithm. Available are
                        Mouse, FVSVMC, Sarsa and QLearning''')
    parser.add_argument('-e', '--exploration', action='store_true',
                        help='''Determines whether the mouse will explore or only
                        exploit.''')
    parser.add_argument('-d', '--draws', type=int, default=5,
